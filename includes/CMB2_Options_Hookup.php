...
class CMB2_Options_Hookup extends CMB2_Hookup {
	...
	public function hooks() {
		...
		register_setting( 'cmb2', $this->option_key, [
			'label'       => $this->cmb->prop( 'title' ),
			'description' => "Holds all the settings for the `{$this->option_key}` options page.",
		] );
		...
		add_action( $hook, [ $this, 'options_page_menu_hooks' ], $this->get_priority() );
